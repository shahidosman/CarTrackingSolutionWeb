                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group m-form__group">
                                                    <label for="request_id">Select Ride Request</label>
                                                    <select class="form-control m-input m-input--square"
                                                            name="request_id" id="request_id">
                                                            <option value="">-- Select Pickup Location --</option>
                                                        @if(is_array($ride_requests) || is_object($ride_requests))
                                                            @foreach($ride_requests as $ride_request)
                                                                    <option value="{{$ride_request->id}}"
                                                                            >
                                                                        {{$ride_request->pick_loc_address}}</option>
                                                            @endforeach
                                                        @else
                    ...
                    success: function(data){
                        if(data){
                            ...
                            $.each(data.data, function (i, item) {
                                ...
                                rows += '<td><a class="btn btn-primary" href="send-driver/'+item.driver_id+'/' +item.request_id + ' "role="button">Send</a></td>'
                                rows += '</tr>';
                            });
