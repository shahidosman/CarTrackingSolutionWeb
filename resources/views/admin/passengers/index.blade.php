            ...
            <div class="m-grid__item m-grid__item--fluid m-wrapper">
                ...
                <div class="m-subheader ">
                    <div class="d-flex align-items-center">
                        <div class="mr-auto">
                            <h3 class="m-subheader__title m-subheader__title--separator">{{Config('constants.passengers')}}</h3>
                ...
                <div class="m-content">
                    <div class="row">
						...
						<i class="la la-gear"></i>
                                ...
                                <!--begin::Form-->
                                <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{url('admin/passengers')}}">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group m-form__group">
                                                    ...
                                                    <input type="text" name="phone_num" value="{{ $existing == null ? old('phone_num') : $existing->phone_num }}" class="form-control m-input" id="phone_num" aria-describedby="emailHelp" placeholder="Enter Phone Number">
                                                </div>
                                ...
                                <div class="m-portlet__body">
                                    ...
                                    <table class="table table-striped- table-bordered table-hover table-checkable responsive no-wrap" id="data">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary" href="{{route('passengers.edit',['passenger' => $item->id])}}" role="button">Edit</a>
